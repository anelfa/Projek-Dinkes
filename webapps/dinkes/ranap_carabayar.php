...
<html>
    ...
    reportsqlinjection();      
        ...
        $_sql = "SELECT setting.kode_ppk, setting.nama_ppk, penjab.png_jawab,Count(reg_periksa.kd_pj) AS jumlah_pasien
				 FROM kamar_inap , reg_periksa , penjab , setting
				 WHERE kamar_inap.no_rawat = reg_periksa.no_rawat AND reg_periksa.kd_pj = penjab.kd_pj and 
				 kamar_inap.tgl_masuk BETWEEN '$tanggal1' AND '$tanggal2'
				 GROUP BY penjab.kd_pj";            
