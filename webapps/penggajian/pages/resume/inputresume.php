        ...
        <form name="frm_pelatihan" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            <table width="100%" align="center">
                <tr class="head">
                    ...
                    <td width="67%">Rp.<input name="pendapatan_resume" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi1'));" type=text id="TxtIsi1" class="inputbox" value="<?php echo $pendapatan_resume;?>" size="30" maxlength="15">
            ...
            <?php
                ...
                if (isset($BtnSimpan)) {
                    $pendapatan_resume    = trim($_POST['pendapatan_resume']);
		    ...
		    $bagian_kry         =($persen_kry/100)*$pendapatan_resume;
                    if ((!empty($pendapatan_resume))&&(!empty($persen_rs))&&(!empty($persen_kry))) {
                        switch($action) {
                            case "TAMBAH":
                    ...
                    }else if ((empty($pendapatan_resume))||(empty($persen_rs))||(empty($persen_kry))){
