...
<div id="ket"><h><b>&ensp;&ensp;&ensp;Unit Rekam Medis &ensp;<span style="color: blue">< Kontrol Automatis ></span></b><ul><a href="../index.php">Home</a> &nbsp;&nbsp;<a href="rm.php">Rekam Medis</a></ul></h></div>
<div id="body">
     <div id="kontent1">
...
<?php //..........................................................................................................................?>   
            <div class="tabel1">
              <center>
             <form action='rm_kstatus.php' method='POST' name='ApaAjaNamanya'>
                <table>
                    <tr>
                      <td>Tanggal Awal</td>
                      <td>:</td>
                     ...
                     ?>  
                          <tr>  
                               ...
                               <?php if (strtoupper($row['stts_rm'])=='KEMBALI'){ 
                                ...
                                ?>                             
                                <td align="center"><a href="p_rajal.php?id=<?php echo $row['no_rkm_medis']?>"><b>RAJAL<b></a></td>
                                <td align="center"><a href="p_gigi.php?id=<?php echo $row['no_rkm_medis']?>"><b>GIGI<b></a></td>
                                <td align="center"><a href="p_igd.php?id=<?php echo $row['no_rkm_medis']?>"><b>IGD<b></td>
                          </tr>  
                     <?php  
                     }  
                     ?>  
