...
<div id="kontentg">
        ...
        ?>
          ...
          <table width="390" border="0" align="right">
            <tr>
              <th colspan="2" scope="col" align="left" height="25"><?php echo $row['no_rkm_medis'];?></th>
            </tr>
            <tr>
              <td height="25"><h><?php echo $row['nm_pasien'];?>&nbsp;&nbsp;&nbsp;(<?php echo $row['jk'];?>)</td>
              <td height="25" align="right"><h><?php echo $row['agama'];?>&nbsp;&nbsp;&nbsp;</td>
            </tr>
            <tr>
              <td width="220" height="25"><h><?php echo "".konversi_tanggal($row['tgl_lahir'])."" ?></td>
              <td width="160" height="25" align="right"><h><?php $lahir=new datetime($row['tgl_lahir']);
                        $today = new DateTime();
                        $umur=$today->diff($lahir);
                        echo $umur->y; echo" {th} - "; echo $umur->m; echo" {bl} - "; echo $umur->d; echo" {hr} ";?>&nbsp;</td>
            </tr>
            <tr>
              <td colspan="2" height="25"><l><?php echo $row['alamat'];?>&nbsp;,<?php echo $row['nm_kel'];?>&nbsp;,<?php echo $row['nm_kec'];?>&nbsp;,<?php echo $row['nm_kab'];?></td>
            </tr>
            <tr>
              <td height="25"><h><?php echo $row['pnd'];?></td>
              <td height="25" align="right"><h><?php echo $row['pekerjaan'];?>&nbsp;</td>
            </tr>
            <tr>
...
//            dan menuliskan kembali html ke dalamnya
            function printDiv(divId) {
                ...
                newWin.document.write('<div id="kontentg">');
