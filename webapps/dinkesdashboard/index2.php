            ...
            <ul class="nav nav-stacked">
				...
				<li class="nav-header"> <a href="#" data-toggle="collapse" data-target="#menu3"> Laporan RL 3 - Pelayanan <i class="glyphicon glyphicon-chevron-right"></i></a>
                    ...
                    <ul class="nav nav-stacked collapse" id="menu3">
						...
						<li><a href="?module=3.8">Laporan RL 3.8</a>
                        </li>
				...
				<li class="nav-header"> <a href="?module=jk" data-toggle="collapse" data-target="#menu5"> Laporan Berdasarkan Jenis Kelamin <i class="glyphicon glyphicon-chevron-right"></i></a>
				</li>
