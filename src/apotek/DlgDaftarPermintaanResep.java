...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
        ...
        if(tabMode.getRowCount()!=0){
            ...
            if(evt.getClickCount()==2){
                if(var.getberi_obat()==true){
                    filter=tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(),7).toString();
                    if(filter.equals("Sudah Terlayani"))
                    {
                      JOptionPane.showMessageDialog(null,"Maaf, Resep Ini Sudah Dilayani");  
                    }
                    else{
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
       filter=tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(),7).toString();
        ...
        else if(filter.equals("Sudah Terlayani")){
            JOptionPane.showMessageDialog(null,"Maaf, Resep Ini Sudah Dilayani");  
             }
