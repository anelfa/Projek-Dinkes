...
public final class DlgKategoriPemasukan extends javax.swing.JDialog {
    ...
    public DlgKategoriPemasukan(java.awt.Frame parent, boolean modal) {
        ...
        rekening.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(var.getform().equals("DlgKategoriPemasukan")){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Kategori Pemasukan Lain-Lain ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(100,80,80))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptKategoriPemasukanLain.jrxml","report","::[ Kategori Pemasukan Lain ]::",
...
//   Valid.pindah(evt,Kd,Tahun);
    ...
    private void BtnAkunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAkunActionPerformed
        var.setform("DlgKategoriPemasukan");
        pilihan=1;
        rekening.emptTeks();
        rekening.tampil();
        rekening.isCek();
    ...
    */
    ...
    public void isCek(){
        ...
        BtnBatal.setEnabled(var.getpemasukan_lain());
        BtnEdit.setEnabled(var.getpemasukan_lain());
        BtnHapus.setEnabled(var.getpemasukan_lain());
        BtnPrint.setEnabled(var.getpemasukan_lain());
        ppSimpan.setEnabled(var.getpemasukan_lain());
        ppGanti.setEnabled(var.getpemasukan_lain());        
        ppHapus.setEnabled(var.getpemasukan_lain());
        ppCetak.setEnabled(var.getpemasukan_lain());        
    }
}
