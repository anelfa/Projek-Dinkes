...
public final class DlgKunjunganRalan extends javax.swing.JDialog {
    ...
    public DlgKunjunganRalan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"No.","Lama","Baru","Nama Pasien","L","P","Alamat","Diagnosa","Dokter Jaga"};
        ...
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg,pasien.jk,concat(reg_periksa.thn_umur,' Th ',reg_periksa.bln_umur,' Bl ',reg_periksa.hr_umur,' Hr') as umur,pasien.tgl_daftar " +
