...
public class DlgFrekuensiPenyakitRalan extends javax.swing.JDialog {
    ...
    public DlgFrekuensiPenyakitRalan(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ps=koneksi.prepareStatement("select penyakit.kd_penyakit,SUBSTRING(penyakit.nm_penyakit,1,80) as penyakit from penyakit inner join diagnosa_pasien inner join reg_periksa "+
                    ...
                    "where diagnosa_pasien.status='Ralan' and diagnosa_pasien.prioritas='1' and penyakit.kd_penyakit like ? and reg_periksa.tgl_registrasi between ? and ? group by penyakit.kd_penyakit order by penyakit.kd_penyakit");
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Rekap Frekuensi Penyakit Di Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(130, 100, 100))); // NOI18N
