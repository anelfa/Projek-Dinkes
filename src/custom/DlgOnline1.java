 ...
 * @author dosen
 */
public final class DlgOnline1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgOnline1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                    com.sun.awt.AWTUtilities.setWindowOpacity(DlgCatatan,0.5f);
    ...
    private void initComponents() {
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-01-2019" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-01-2019" }));
        ...
        DTPReg.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-01-2019" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgOnline1 dialog = new DlgOnline1(new javax.swing.JFrame(), true);
