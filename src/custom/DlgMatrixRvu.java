 ...
 * @author dosen
 */
public class DlgMatrixRvu extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMatrixRvu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Matrix Rvu IDI ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        panelBiasa1.setPreferredSize(new java.awt.Dimension(1023, 120));
        ...
        BtnPoli1.setVerifyInputWhenFocusTarget(false);
        BtnPoli1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPoli1ActionPerformed(evt);
            }
        });
        panelBiasa1.add(BtnPoli1);
        BtnPoli1.setBounds(577, 73, 28, 23);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMatrixRvu dialog = new DlgMatrixRvu(new javax.swing.JFrame(), true);
