 ...
 * @author dosen
 */
public final class DlgCasemix extends javax.swing.JDialog {
    private final DefaultTableModel tabModekasir;
    private sekuel Sequel=new sekuel();
    private validasi Valid=new validasi();
    private Connection koneksi=koneksiDB.condb();
    private PreparedStatement psotomatis,psotomatis2,pskasir,pscaripiutang,psbilling,psallpertindakan;
    private ResultSet rskasir,rssall,rsbilling;
    double countall;
     ...
     * @param parent
     * @param modal */
    public DlgCasemix(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] rowkasir={"Status","No.Rawat","Nama Pasien","Nomor RM","Dokter","Poliklinik","Tindakan","Laboratorium","Radiologi","Obat",
                           "Penunjang","Keperawatan","Prosedur Bedah","Prosedur Non Bedah","Pelayanan Darah","Rawat Intensif","Kamar","Total"};
        ...
        tbKasirRalan.setDefaultRenderer(Object.class, new TableCasemix());
       ...
       if(TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariInteger("select count(no_rawat) from kamar_inap where no_rawat=?",TNoRw.getText())>0){
               ...
               Valid.editTable(tabModekasir,"reg_periksa","no_rawat",TNoRw,"stts='Sudah'");
                if(tabModekasir.getRowCount()!=0){tampil();}
            }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCasemix dialog = new DlgCasemix(new javax.swing.JFrame(), true);
    ...
    public void tampil() {                   
        ...
        try{   
            ...
            pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                ...
                "reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg,reg_periksa.stts,penjab.png_jawab,reg_periksa.status_lanjut,reg_periksa.status_bayar  "+
                ...
                "  reg_periksa.kd_pj='C02' and reg_periksa.status_bayar='Sudah Bayar' and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and reg_periksa.no_reg like ? or "+
                "  reg_periksa.kd_pj='C02' and reg_periksa.status_bayar='Sudah Bayar' and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.no_rawat like ? or "+
                "  reg_periksa.kd_pj='C02' and reg_periksa.status_bayar='Sudah Bayar' and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.tgl_registrasi like ? or "+
                "  reg_periksa.kd_pj='C02' and reg_periksa.status_bayar='Sudah Bayar' and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.kd_dokter like ? or "+
                "  reg_periksa.kd_pj='C02' and reg_periksa.status_bayar='Sudah Bayar' and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  dokter.nm_dokter like ? or "+
                "  reg_periksa.kd_pj='C02' and reg_periksa.status_bayar='Sudah Bayar' and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.no_rkm_medis like ? or "+
                "  reg_periksa.kd_pj='C02' and reg_periksa.status_bayar='Sudah Bayar' and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  pasien.nm_pasien like ? or "+
                "  reg_periksa.kd_pj='C02' and reg_periksa.status_bayar='Sudah Bayar' and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  poliklinik.nm_poli like ? or "+
                "  reg_periksa.kd_pj='C02' and reg_periksa.status_bayar='Sudah Bayar' and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.p_jawab like ? or "+
                "  reg_periksa.kd_pj='C02' and reg_periksa.status_bayar='Sudah Bayar' and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  penjab.png_jawab like ? or "+
                "  reg_periksa.kd_pj='C02' and reg_periksa.status_bayar='Sudah Bayar' and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.almt_pj like ? or "+
                "  reg_periksa.kd_pj='C02' and reg_periksa.status_bayar='Sudah Bayar' and poliklinik.nm_poli like ? and  dokter.nm_dokter like ? and reg_periksa.stts like ? and reg_periksa.tgl_registrasi between ? and ? and  reg_periksa.hubunganpj like ? order by reg_periksa.no_rawat desc");
            try{
                ...
                while(rskasir.next()){
                    ...
                    Laborat=0;Radiologi=0;Obat=0;Ralan_Dokter=0;Ralan_Dokter_Paramedis=0;Ralan_Paramedis=0;Tambahan=0;Potongan=0;Registrasi=0;
                            ...
                            try {
                                psbilling.setString(1,rskasir.getString("no_rawat"));
                                ...
                                tabModekasir.addRow(new String[] {
                                   rskasir.getString("status_lanjut"),
