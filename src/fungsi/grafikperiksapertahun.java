    ...
    public static CategoryDataset createDataset1(String symbol) { //data grafik nilai K dan D
          ...
          String series2 = "Tahun";
            ...
            try {
                ...
                ResultSet rs = stat.executeQuery("select year(reg_periksa.tgl_registrasi),count(year(reg_periksa.tgl_registrasi)) as jumlah "+
                   "from reg_periksa  "+
                   symbol+" group by year(reg_periksa.tgl_registrasi)");
                while (rs.next()) {
