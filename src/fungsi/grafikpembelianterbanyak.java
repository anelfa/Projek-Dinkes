    ...
    public static CategoryDataset createDataset1(String symbol) { //data grafik nilai K dan D
          ...
          DecimalFormat df2 = new DecimalFormat("###,###,###,###,###,###,###"); 
            ...
            try {
                ...
                ResultSet rs = stat.executeQuery("SELECT detailbeli.kode_brng,sum(detailbeli.jumlah),sum(detailbeli.subtotal) from pembelian inner join detailbeli "+
                        " on pembelian.no_faktur=detailbeli.no_faktur where "+symbol+" group by kode_brng order by sum(detailbeli.jumlah) desc limit 10");
                while (rs.next()) {
