...
public class DlgPasienPenunjang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2018" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2018" }));
                ...
                if(posisitahun.equals("Depan")){
                    ...
                    switch (pengurutan) {
                        case "Straight":
                            ...
                            break;
                        case "Terminal":
                            Valid.autoNomer4("select ifnull(MAX(CONVERT(CONCAT(SUBSTRING(LEFT(no_rkm_medis_penunjang,9),5,2),SUBSTRING(LEFT(no_rkm_medis_penunjang,9),3,2),SUBSTRING(LEFT(no_rkm_medis_penunjang,9),1,2)),signed)),0) from set_no_rkm_medis_penunjang","",9,NoRm);
                            break;
                        case "Middle":
                            Valid.autoNomer5("select ifnull(MAX(CONVERT(CONCAT(SUBSTRING(LEFT(no_rkm_medis_penunjang,9),3,2),SUBSTRING(LEFT(no_rkm_medis_penunjang,9),1,2),SUBSTRING(LEFT(no_rkm_medis_penunjang,9),5,2)),signed)),0) from set_no_rkm_medis_penunjang","",9,NoRm);
                            break;
                    }            
                }
