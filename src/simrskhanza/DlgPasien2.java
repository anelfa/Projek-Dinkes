 ...
 * @author igos
 */
public class DlgPasien2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal*/
    public DlgPasien2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MnBarcodeRM7.setPreferredSize(new java.awt.Dimension(250, 25));
        ...
        MenuIdentitas.setPreferredSize(new java.awt.Dimension(180, 30));
        ...
        MnIdentitas.setPreferredSize(new java.awt.Dimension(250, 25));
        ...
        MnIdentitas2.setPreferredSize(new java.awt.Dimension(250, 25));
        ...
        MnIdentitas3.setPreferredSize(new java.awt.Dimension(250, 25));
        ...
        internalFrame3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 235, 225)), "::[ Demografi Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 0, 13), new java.awt.Color(50, 70, 50))); // NOI18N
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 0, 13), new java.awt.Color(50, 70, 40))); // NOI18N
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-03-2018" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-03-2018" }));
        ...
        ChkAlamatSama.setBounds(830, 190, 23, 23);
        ...
        TNo_reg.setEditable(false);
        TNo_reg.setBackground(new java.awt.Color(245, 250, 240));
        TNo_reg.setHighlighter(null);
        TNo_reg.setName("TNo_reg"); // NOI18N
        TNo_reg.setOpaque(true);
        TNo_reg.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TNo_regKeyPressed(evt);
            }
        });
        FormInput.add(TNo_reg);
        TNo_reg.setBounds(300, 12, 130, 23);
...
//            Sequel.queryu3("insert into kabupaten values(?,?)",2,new String[]{"0",Kabupaten.getText().replaceAll("KABUPATEN","-")});
            ...
            if(Sequel.menyimpantf2("pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rekam Medis Pasien",31,new String[]{
                ...
                Sequel.mengedit("reg_periksa_temporary","no_registrasi=?"," no_rkm_medis=?",2,new String[]{TNo.getText(),TNo_reg.getText()});
                ...
                if(Sequel.menyimpantf2("pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rekam Medis Pasien",31,new String[]{
                    ...
                    Valid.editTable(tabMode,"reg_periksa_temporary","no_registrasi","?","no_rkm_medis=?",2,
                        new String[]{TNo_reg.getText(),TNo.getText()});
                    emptTeks(); 
                }else{
                    autoNomor();
                    if(Sequel.menyimpantf2("pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rekam Medis Pasien",31,new String[]{
    ...
    public void tampil() {     
        ...
        try{
            ps=koneksi.prepareStatement("select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "+
                   "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat, pasien.gol_darah, pasien.pekerjaan,"+
                   "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp, pasien.umur as umur,"+
        ...
        if(tbPasien.getSelectedRow()!= -1){                
            try {                
                ...
                pscariwilayah=koneksi.prepareStatement(
                        ...
                        "pasien.alamatpj,pasien.kelurahanpj,pasien.kecamatanpj,pasien.kabupatenpj, pasien.kd_kel,pasien.kd_kec,pasien.kd_kab from pasien "+
...
//        }
    ...
    public void setNoRm(String no_reg) {
        ...
        try {
            ps3=koneksi.prepareStatement("select pasien_temporary.keluarga,pasien_temporary.namakeluarga,pasien_temporary.pekerjaanpj,pasien_temporary.alamatpj,pasien_temporary.no_registrasi,stts_nikah,no_ktp,agama,pekerjaan,alamat,no_tlp,no_peserta,kd_kel,nm_pasien,jk,gol_darah,tmp_lahir,tgl_lahir,png_jawab,reg_periksa_temporary.kd_pj from pasien_temporary Join reg_periksa_temporary JOIN penjab On pasien_temporary.no_registrasi=reg_periksa_temporary.no_registrasi and reg_periksa_temporary.kd_pj=penjab.kd_pj where pasien_temporary.no_registrasi=?");
            try {
                ps3.setString(1,no_reg);
                rs3=ps3.executeQuery();
                 while(rs3.next()){
                    TNm.setText(rs3.getString("nm_pasien"));
                    if(rs3.getString("jk").equals("P"))
                    {
                        CmbJk.setSelectedItem("PEREMPUAN");
                    }
                    else if(rs3.getString("jk").equals("L"))
                    {
                        CmbJk.setSelectedItem("LAKI_LAKI");
                    }
                    if(rs3.getString("gol_darah").equals("A"))
                    {
                        CMbGd.setSelectedItem("A");
                    }
                    else if(rs3.getString("gol_darah").equals("B"))
                    {
                        CMbGd.setSelectedItem("B");
                    }
                    else if(rs3.getString("gol_darah").equals("AB"))
                    {
                        CMbGd.setSelectedItem("AB");
                    }
                    else if(rs3.getString("gol_darah").equals("-"))
                    {
                        CMbGd.setSelectedItem("-");
                    }
                    TTmp.setText(rs3.getString("tmp_lahir"));
                    
                    Valid.SetTgl(DTPLahir,rs3.getString("tgl_lahir"));
                    nmpnj.setText(rs3.getString("png_jawab"));
                    Kdpnj.setText(rs3.getString("kd_pj"));
                    TNoPeserta.setText(rs3.getString("no_peserta"));
                    Kelurahan.setText(rs3.getString("kd_kel"));
                     Kelurahan.setText(Sequel.cariIsi("select kelurahan.nm_kel from kelurahan where kelurahan.kd_kel=?",rs3.getString("kd_kel")));
                            id_kel=rs3.getString("kd_kel");
                            id_kec=Sequel.cariIsi("select kelurahan.kd_kec from kelurahan where kelurahan.kd_kel=?",id_kel);
                            nm_kec=Sequel.cariIsi("select kecamatan.nm_kec from kecamatan where kecamatan.kd_kec=?",id_kec);
                            Kecamatan.setText(nm_kec);
                            id_kab=Sequel.cariIsi("select kecamatan.kd_kab from kecamatan where kecamatan.kd_kec=?",id_kec);
                            ...
                            Kabupaten.setText(nm_kab);   
                            Kelurahan.requestFocus();
                            Alamat.setText(rs3.getString("alamat"));
                            TTlp.setText(rs3.getString("no_tlp"));
                            Pekerjaan.setText(rs3.getString("pekerjaan"));
                            TKtp.setText(rs3.getString("no_ktp"));
                            cmbAgama.setSelectedItem(rs3.getString("agama"));
                            CmbStts.setSelectedItem(rs3.getString("stts_nikah"));
                            NmIbu.setText("");
                            Saudara.setText(rs3.getString("keluarga"));
                            PekerjaanPj.setText(rs3.getString("pekerjaanpj"));
                            TNo_reg.setText(rs3.getString("no_registrasi"));
               }
