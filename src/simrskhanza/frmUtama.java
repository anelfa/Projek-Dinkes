...
public class frmUtama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnBPJSSEP.setText("Data Bridging SEP");
        ...
        tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24/02/2018" }));
        ...
        jMenu8.setBackground(javax.swing.UIManager.getDefaults().getColor("textText"));
...
private void BtnToolRegActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnToolRegActionPerformed
        ...
        kasirralan.kamarinap.reg.tampil3();
...
private void BtnSimpanPassKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanPassKeyPressed
    ...
    private void btnMutasiBerkasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMutasiBerkasActionPerformed
        ...
        try {
            Hybrid.loadURL("http://"+prop.getProperty("HOSTWEBSERVICE")+"/"+prop.getProperty("HYBRIDWEB")+"/"+"monitoringberkas/login.php?act=login&usere=admin&passwordte=akusayangsamakamu");                    
        } catch (Exception ex) {
            System.out.println("Notifikasi : "+ex);
        }
